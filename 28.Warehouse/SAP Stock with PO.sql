CREATE OR ALTER PROCEDURE SP_R_SAPWHSStockByPO
 @Factory nvarchar(200) = '2503,2513',
 @MaterialType nvarchar(5) = 'ZROH'
as
select (
select MaterialGroup,MaterialGroupDescription,POGroup as PO
...
group by MaterialGroup,MaterialGroupDescription,POGroup
